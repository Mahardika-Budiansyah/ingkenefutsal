...
<nav class="bg-white border-teal-200 fixed top-0 w-full z-10">
    <div class="max-w-screen-lg flex flex-wrap items-center justify-between mx-auto p-6">
        ...
        <div class="flex md:order-2 space-x-3 md:space-x-0">
            @if (Auth::guard('web')->check() && Auth::guard('web')->user()->name)
                <button data-collapse-toggle="navbar-cart" data-modal-toggle="navbar-cart" type="button"
                    ...
                    <span id="totalItemsInCart" class="bg-red-700 text-white rounded-full px-1.5 ml-5 mb-5 pb-0.5 justify-center text-xs absolute">0</span>
                </button>
            ...
            @else
                <div class="flex gap-x-0.5">
                    <button type="button" data-modal-target="sign-in-modal" data-modal-toggle="sign-in-modal"
                        ...
                        aria-controls="navbar-cart" aria-expanded="false">
                        <span class="sr-only">Cart</span>
                        <span class="bg-red-700 text-white rounded-full px-1.5 ml-5 mb-5 pb-0.5 justify-center text-xs absolute">0</span>
                    </button>
