            ...
            <div class="relative z-0 flex flex-col min-w-0 break-words bg-white border-0 shadow-xl rounded-2xl bg-clip-border">
              ...
              <div class="flex-auto p-6">
                <form role="form text-left" action="{{ route('partner.register.store') }}" method="POST">
                  ...
                  <p class="mt-4 mb-0 leading-normal text-sm">Already have an account? <a href="{{ route('partner.login_from') }}" class="font-bold text-slate-700">Sign in</a></p>
                </form>
              </div>
            </div>
          </div>
