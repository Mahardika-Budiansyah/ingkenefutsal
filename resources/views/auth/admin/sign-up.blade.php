          ...
          <div class="w-full max-w-full px-3 mx-auto mt-0 md:flex-0 shrink-0 md:w-7/12 lg:w-5/12 xl:w-4/12">
            <div class="relative z-0 flex flex-col min-w-0 break-words bg-white border-0 shadow-xl rounded-2xl bg-clip-border">
              <div class="px-6 pb-0 py-6 mb-0 text-center bg-white border-b-0 rounded-t-2xl">
                ...
                <p><i>(Registration Account Admin)</i></p>
              </div>
              ...
              <div class="flex-auto p-6">
                <form role="form text-left" action="{{ route('admin.register.store') }}" method="POST">
                  @csrf
                  <div class="mb-4">
                  ...
                  <div class="mb-4">
                    <label for="Re-type Password" class="block text-gray-700 text-sm font-bold mb-1">Re-type Password:</label>
                  ...
                  <p class="mt-4 mb-0 leading-normal text-sm">Already have an account? <a href="{{ route('admin.login_from') }}" class="font-bold text-slate-700">Sign in</a></p>
                </form>
              </div>
            </div>
          </div>
