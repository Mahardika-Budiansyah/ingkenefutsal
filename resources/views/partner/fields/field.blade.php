            ...
            <div
                ...
                <div class="flex flex-wrap justify-between">
                    <div class="p-6 pb-0 mb-0 border-b-0 border-b-solid rounded-t-2xl border-b-transparent">
                        <p class="font-semibold uppercase">All Fields</p>
                    </div>
                    <div class="p-4 pb-0 mb-0 d-flex align-items-center">
                        <a href="{{ route('field.create') }}">
                            <button type="button" class="text-white bg-gradient-to-tr from-teal-600 to-cyan-800 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2">
                                +&nbsp; New Field
                            </button>
                        </a>
                    </div>
                ...
                <div class="flex-auto px-0 pt-0 pb-2">
                    <div class="p-0 overflow-x-auto">
                                ...
                                @foreach ($fields as $data)
                                    <tr>
                                        <td
                                            ...
                                            <p
                                                class="mb-0 text-center text-xs font-semibold leading-tight">
                                                {{ $loop->iteration }}
                                            </p>
                                        </td>
                                        <td
                                        ...
                                        <td class="p-2 text-center align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                            <a href="{{ route('field.show', $data->slug) }}" data-bs-toggle="tooltip" data-bs-original-title="detail">
                                                <button type="button" class="focus:outline-none text-white bg-blue-500 hover:bg-blue-600 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-xs px-4 py-2.5 mr-2 mb-2">
                                            ...
                                            <a href="{{ route('field.edit', $data->slug) }}" class="mx-1" data-bs-toggle="tooltip" data-bs-original-title="edit">
                                                <button type="button" class="focus:outline-none text-white bg-green-500 hover:bg-green-600 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-xs px-4 py-2.5 mr-2 mb-2">
                                                    <i class="fas fa-user-edit text-white pe-1"></i> Edit
                                                </button>
                                            </a>
                                            <a href="{{ route('field.destroy', $data->id) }}" data-confirm-delete="true" class="focus:outline-none text-white bg-red-500 hover:bg-red-600 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-xs px-4 py-2.5 mr-2 mb-2">
                                                @method('delete')
                        ...
                        <div class="my-3 mx-6">
                            {{ $fields->withQueryString()->links('vendor.pagination.tailwind') }}
                        </div>
                    </div>
                </div>
            </div>
